...
<div class="position-absolute ">
    ...
    <div class="my-3 d-flex justify-content-end">
        <?php if ($this->session->userdata('access') != 'Admin') { ?>
            ...
            <a href="<?php echo base_url('assetkeluar/tambahdetailassetkeluar/' . $kode) ?>" class="btn btn-primary">+ Tambah </a>
            <?php ?>
        <?php } ?>
    </div>
        ...
        <body>
            ...
            ?>
                ...
                <tr>
                    ...
                    <?php if ($this->session->userdata('access') != 'Admin') { ?>
                        <td> <a href="<?php echo base_url('/assetkeluar/editKeluarDetail') ?>/<?php echo $row->kode_keluar ?> " class=" btn btn-warning"></button>edit</a>
                            <br></br>


                            <a href="<?php echo base_url() . "assetkeluar/deletedetailassetkeluar/" . $row->kode_keluar; ?> " class=" btn btn-danger" onclick="return confirm('Apakah anda yakin ?');"></button>Hapus</a>
                        <?php } ?>
                        </td>

...
<div class="position-absolute ">
    ...
    <div class="my-3 d-flex justify-content-end">
        <?php if ($this->session->userdata('access') != 'Admin') { ?>
            ...
            <a href="<?php echo base_url('writeoff/tambahdetailassetwriteoff/' . $kode) ?>" class="btn btn-primary">+ Tambah </a>
            <?php ?>
        <?php } ?>
    </div>
        ...
        <body>
            ...
            ?>
                ...
                <tr>
                    ...
                    <?php if ($this->session->userdata('access') != 'Admin') { ?>
                        <td> <a href="<?php echo base_url('/writeoff/editWriteoffDetail') ?>/<?php echo $row->kode_writeoff ?> " class=" btn btn-warning"></button>edit</a>
                            <br></br>


                            <a href="<?php echo base_url() . "/writeoff/deletedetailassetwriteoff/" . $row->kode_writeoff ?> " class=" btn btn-danger" onclick="return confirm('Apakah anda yakin ?');"></button>Hapus</a>
                        <?php } ?>
                        </td>
                </tr>
        </body>

...
<div class="position-absolute ">
    <h1>Form Tambah Detail Asset Masuk</h1>
    <div class="container">
        <div row>

            <form action="<?php echo base_url() . 'assetmasuk/tambahdetailmasuk'; ?>" method="POST">

                <?php
                $kode = $this->uri->segment(3)  ?>
                <div class="mb-3">
                    <label for="exampleInputEmail1" class="form-label">Kode Masuk</label>
                    <input type="text" value="<?php echo $kode ?>" name="kode_masuk" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" value="<?php echo $as->nama_asset ?>" name="nama_asset" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp">
